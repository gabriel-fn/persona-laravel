...
class PoderesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        factory(Poder::class)->create(['nome'=>'Controle Climático', 'efeito'=>'Geral', 'acao'=>'Padrão', 'alcance'=>'À Distância', 'duracao'=>'Sustentada', 'salvamento'=>'Fortitude', 'custo_max'=>2, 'custo_min'=>2]);
